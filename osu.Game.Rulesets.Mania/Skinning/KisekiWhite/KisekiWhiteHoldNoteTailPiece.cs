...
{
    internal partial class KisekiWhiteHoldNoteTailPiece : CompositeDrawable
    {
        [Resolved]
        ...
        private readonly KisekiWhiteHoldNoteHittingLayer hittingLayer;
        private readonly Box foregroundAdditive;

        public KisekiWhiteHoldNoteTailPiece()
        {
            RelativeSizeAxes = Axes.X;
            Height = KisekiWhiteNotePiece.NOTE_HEIGHT;
                ...
                new Container
                {
                    ...
                    Children = new Drawable[]
                    {
                        ...
                        new Container
                        {
                            ...
                            Height = KisekiWhiteNotePiece.NOTE_ACCENT_RATIO,
                            CornerRadius = KisekiWhiteNotePiece.CORNER_RADIUS,
                            Masking = true,
                            Children = new Drawable[]
                            {
