...
{
    public partial class KisekiWhiteColumnBackground : CompositeDrawable, IKeyBindingHandler<ManiaAction>
    {
        ...
        public KisekiWhiteColumnBackground()
        {
        ...
        private void load(IScrollingInfo scrollingInfo)
        {
            ...
            {
                background.Colour = Color4.Black.Darken(10).Opacity(0f);
