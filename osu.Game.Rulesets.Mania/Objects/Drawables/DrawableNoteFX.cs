...
namespace osu.Game.Rulesets.Mania.Objects.Drawables
{
    ...
    /// </summary>
    public partial class DrawableNoteFX : DrawableManiaHitObject<Note>, IKeyBindingHandler<ManiaAction>
    {
        [Resolved]
        ...
        protected virtual ManiaSkinComponents Component => ManiaSkinComponents.NoteFX;

        private Drawable headPiece;

        public DrawableNoteFX()
            : this(null)
        {
        }

        public DrawableNoteFX(Note hitObject)
            : base(hitObject)
        {
            AutoSizeAxes = Axes.Y;
        }
