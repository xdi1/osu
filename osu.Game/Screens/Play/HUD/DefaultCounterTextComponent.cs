...
{
    public partial class DefaultCounterTextComponent : CompositeDrawable, IHasText
    {
        private readonly DefaultCounterSpriteText textPart;
        ...
        public DefaultCounterTextComponent(Anchor anchor, LocalisableString? label = null)
        {
            Anchor = anchor;
            Origin = anchor;
            ...
            InternalChildren = new Drawable[]
            {
                ...
                NumberContainer = new Container
                {
                    ...
                    Children = new[]
                    {
                        textPart = new DefaultCounterSpriteText(textLookup)
                        {
                            Anchor = anchor,
                            Origin = anchor,
                        },
        ...
        private partial class DefaultCounterSpriteText : OsuSpriteText
        {
            ...
            public DefaultCounterSpriteText(Func<char, string> getLookup)
            {
            ...
            {
                const string font_name = @"default-counter";
            ...
            private class GlyphStore : ITexturedGlyphLookupStore
            {
                ...
                public ITexturedCharacterGlyph? Get(string? fontName, char character)
                {
                    ...
                    var texture = textures.Get($"Gameplay/Fonts/Default/{fontName}-{lookup}");
